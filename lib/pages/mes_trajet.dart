...
const String STATUS_EN_ROUTE = 'en route';      // Nouveau statut pour trajet commencé
...
class _MesTrajetScreenState extends State<MesTrajetScreen> {
                        ...
                        : StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (
                              ...
                              if (snapshot.data == null || snapshot.data!.docs.isEmpty) {
                                ...
                                if (currentUser != null) {
                                  print("ID de l'utilisateur actuel: ${currentUser.uid}");
                              ...
                              print("Nombre de documents: ${snapshot.data!.docs.length}");
  ...
  Widget _buildTripCard(DocumentSnapshot document) {
    try {
      ...
      final String status = tripData[FIELD_STATUS] ?? STATUS_EN_ATTENTE; // Par défaut en attente
      final Color statusColor = _getStatusColor(status);
     
      // Initiales des villes
      final String departureInitial =
          departure.isNotEmpty ? departure.split(',')[0].trim()[0].toUpperCase() : 'X';
      final String arrivalInitial =
          arrival.isNotEmpty ? arrival.split(',')[0].trim()[0].toUpperCase() : 'X';
      ...
      return GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TrajetDetailsScreen(tripId: document.id),
            ),
          ).then((_) {
